...
<section class='login' id='login'>
  ...
  <div class='form'>
    <form method="POST" action="{{ route('login') }}">
        @csrf
  <input type="text" placeholder='Email' name="email" class='text  @error('email') is-invalid @enderror' id='username' required>
  @error('email')
...
@enderror
  <br>
  <input type="password" placeholder='••••••••••••••' name="password" class='password @error('password') is-invalid @enderror' required>
  @error('password')
  <span class="invalid-feedback" role="alert">
      <strong>{{ $message }}</strong>
  </span>
